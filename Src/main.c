...
const unsigned char KEYBOARD_Value_Map[MAX_COL][MAX_ROW] =
{
  ...
  {0           ,0        ,KC_CAPS_LOCK        ,KC_A                           ,KC_S          ,KC_D        ,KC_F          ,KC_G       ,KC_H     ,KC_J        ,KC_K          ,KC_L         ,KC_COLON          ,KC_QUOTE          ,KC_HASH         ,KC_ENTER    ,},
  {0           ,0        ,KC_LSHIFT           ,KC_NON_US_BACKSLASH_AND_SLASH  ,KC_Z          ,KC_X        ,KC_C          ,KC_V       ,KC_B     ,KC_N        ,KC_M          ,KC_COMMA     ,KC_DOT            ,KC_SLASH          ,0               ,KC_RSHIFT   ,},
